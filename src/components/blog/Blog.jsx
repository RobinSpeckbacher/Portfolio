    ...
    <>
        ...
        <article className="post-container" onClick={toggleModalOne}>
          <div className="post-thumb">
            <div className="d-block position-relative overflow-hidden">
              <img
                src="img/blog/Jungspediteur.jpg"
                className="img-fluid"
                alt="Blog Post"
              />
            </div>
          ...
          <div className="post-content">
            <div className="entry-header">
              <h3>Mein Erfolg beim Jungspediteur-Wettbewerb 2022</h3>
            </div>
            <div className="entry-content open-sans-font">
              <p>
              Der Wettbewerb fand in Wien statt, wo ich eingeladen wurde, meine Idee vor dem Zentral Fachverband der Spediteure zu präsentieren.</p>
            </div>
          </div>
          {/* End .post-content */}
        </article>
      ...
      <div className="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
        <article className="post-container" onClick={toggleModalTwo}>
          <div className="post-thumb">
            <div className="d-block position-relative overflow-hidden">
              <img
                src="img/blog/Landessprachenwettbewerb.jpg"
                className="img-fluid"
                alt="Blog Post"
              />
            </div>
          ...
          <div className="post-content">
            <div className="entry-header">
              <h3>Erfolg beim Sprachenwettbewerb Englisch </h3>
            </div>
            <div className="entry-content open-sans-font">
              <p>
            Der Wettbewerb versammelte talentierte Schüler aus verschiedenen Schulen in Salzburg, die ihre Fähigkeiten in der englischen Sprache präsentierten.
              </p>
            </div>
          </div>
          {/* End .post-content */}
      ...
      <div className="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
        <article className="post-container" onClick={toggleModalThree}>
          <div className="post-thumb">
            <div className="d-block position-relative overflow-hidden">
              <img
                src="img/blog/kindheitsfoto.jpg"
                className="img-fluid"
                alt="Blog Post"
                            />
            </div>
          ...
          <div className="post-content">
            <div className="entry-header">
              <h3>Als Expterte bei der WU Wien</h3>
            </div>
            <div className="entry-content open-sans-font">
              <p>
      ...
      <div className="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
        <article className="post-container" onClick={toggleModalSix}>
          ...
          <div className="post-content">
            <div className="entry-header">
              <h3>Parkour und Freerunning - (M)ein etwas anderes Hobby</h3>
            </div>
            <div className="entry-content open-sans-font">
              <p>
                Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
